...
need database for fish
    each fish is an object
        fish properties: Species, Weight, Price, Amount 

// create fish array
cosnt possibleFishInSea = [
...
const boatInventory = () => {
// push the fish caught into todaysCatch as objects
// *possibly randomize fishies*
// return value of todaysCatch
...
for (cost fish of possibleFishInSea)

todaysCatch[fish.species].push(fish)
